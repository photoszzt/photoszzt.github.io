...
- SpecCompiler
  - Two-phase prompting - First phase, it generates a correct sequential implementation of the module, focusing only on its core functionality. - Second phase, it uses the dedicated concurrency specification to instrument this sequential code with the necessary
