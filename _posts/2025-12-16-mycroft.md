...
<img width="1155" height="671" alt="image" src="https://github.com/user-attachments/assets/9f314554-8ca0-4176-966d-6dfdfa436777" />
...
Debugging toolset
<img width="1175" height="419" alt="image" src="https://github.com/user-attachments/assets/b7a230e2-c32b-4c50-be66-1c57877f4560" />

- Dump Python stacks of each rank using py-spy to identify the data loader or checkpoint stuck
  - Stack traces of all relevant Python programs are dumped automatically when Mycroft detects a trigger. Stacks are then grouped by process commands across all GPUs and mapped into a topology grid,
    where each block represents a GPU rank with its current Python call stack. In this grid, identical call stacks will be marked in the same color.
